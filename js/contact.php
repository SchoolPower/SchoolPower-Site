...
if ( empty($_REQUEST['last']) ) {
  ...
  echo "<script>$(\".message-co\").toggle();$(\".message-co\").toggle().hide(\"fast\").show(\"fast\"); </script>";
  echo "<script>$(\".message-co .alert-co\").addClass('alert-danger').removeClass('alert-success'); </script>";
  echo $errormessage;
  echo $alert;
	...
	echo "<script>$(\".message-co\").toggle();$(\".message-co\").toggle().hide(\"fast\").show(\"fast\");$('#contactForm')[0].reset();</script>";
	echo "<script>$(\".message-co .alert-co\").addClass('alert-success').removeClass('alert-danger'); </script>";
	echo $thanks;
	echo "<script>jQuery(\"#name\").removeClass(\"error\");jQuery(\"#email\").removeClass(\"error\");</script>";
	echo "<script>$(\".message-co .alert-co\").delay(4000).hide(\"fast\");</script>";
	die();
